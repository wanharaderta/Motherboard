...
struct Constants {
    ...
    static let searchForASetting = "Search for a setting"
    static let accountAndAccessManagement = "Account and Access Management"
    static let accountSettings = "Account Settings"
    static let children = "Children"
    static let caregivers = "Caregivers"
    static let subscriptions = "Subscriptions"
    static let appMode = "App Mode"
    static let caregiverMode = "Caregiver mode"
    static let notifications = "Notifications"
    static let completedRoutine = "Completed Routine"
    static let lateRoutine = "Late Routine"
    static let delayedRoutine = "Delayed Routine"
    static let logout = "Logout"
    static let manageAccountDetails = "Manage your personal account details"
    static let personalInformation = "Personal Information"
    static let security = "Security"
    static let enableFaceID = "Enable face ID"
    static let deactivateAccount = "Deactivate Account"
